...
if __name__ == "__main__":
    BatchRun(domain="string", files=([],range(50),[]), search_algorithm=AStar(60, weight=0.75, distance_override='levenshtein'), outfile_suffix="astar0.75_ls", print_results=True, multi_core=True).run()
