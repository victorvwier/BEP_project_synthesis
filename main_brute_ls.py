...
if __name__ == "__main__":
    BatchRun(domain="string", files=([],range(50),[]), search_algorithm=AStar(60, weight=0, heuristic_override='sum', distance_override='levenshtein'), outfile_suffix="brute_ls", print_results=True, multi_core=True).run()
