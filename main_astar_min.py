...
if __name__ == "__main__":
    BatchRun(domain="string", files=([],range(50),[]), search_algorithm=AStar(60, heuristic_override='min'), outfile_suffix="astar_min", print_results=True, multi_core=True).run()
